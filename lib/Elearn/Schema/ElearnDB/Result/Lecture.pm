package Elearn::Schema::ElearnDB::Result::Lecture;
...
__PACKAGE__->has_many(
  "chapters",
  "Elearn::Schema::ElearnDB::Result::Chapter",
...
__PACKAGE__->has_many(
  "feedbacks",
  "Elearn::Schema::ElearnDB::Result::Feedback",
  { "foreign.lectureid" => "self.filename" },
);
__PACKAGE__->belongs_to(
  "category",
  "Elearn::Schema::ElearnDB::Result::Categories",
  { category => "category" },
);
__PACKAGE__->has_many(
  "lecture_has_tags",
...
__PACKAGE__->has_many(
  "lecture_questions",
  "Elearn::Schema::ElearnDB::Result::LectureQuestions",
  { "foreign.lecture" => "self.filename" },
);
__PACKAGE__->has_many(
  "user_lecture_datas",
  "Elearn::Schema::ElearnDB::Result::UserLectureData",
  { "foreign.lecture" => "self.filename" },
);
__PACKAGE__->has_many(
  "user_watched_lectures",
  "Elearn::Schema::ElearnDB::Result::UserWatchedLecture",
  { "foreign.lecture" => "self.filename" },
);


# Created by DBIx::Class::Schema::Loader v0.04006 @ 2010-08-24 13:51:06
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:miPHQApgFaiCQpj4t+z5oQ
