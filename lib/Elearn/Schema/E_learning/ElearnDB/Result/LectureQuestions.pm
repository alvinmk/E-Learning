package Elearn::Schema::E_learning::ElearnDB::Result::LectureQuestions;
...
__PACKAGE__->has_many(
  ...
  "Elearn::Schema::E_learning::ElearnDB::Result::UserQuestionAnswers",
  { "foreign.question" => "self.question_id" },
);


# Created by DBIx::Class::Schema::Loader v0.04006 @ 2010-09-03 15:53:04
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HZZRmYD0AN7z4rij33UlUA
